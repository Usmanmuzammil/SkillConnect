...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Delete Attendence Sheet</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            Do you want to Delete Attendence Sheet , All this dependencies will also be Deleted...
        </div>
        <div class="modal-footer">
            <form action="{{ route('attendencesheet.destroy', $data->id) }}" method="POST">
                @csrf
                @method('DELETE')
